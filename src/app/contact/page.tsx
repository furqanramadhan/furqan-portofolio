...
const BOOT_LINES = [
  "$ init contact.sh",
  "$ loading form modules...",
  "$ web3forms API — connected",
...
export default function Contact({ isDark = true }: ContactProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("access_key", "f6e2652f-35a4-49bd-9680-756c1fe9aca9");
  ...
  const socials = [
    ...
    },
    {
      ...
      href: "https://www.instagram.com/furqanramadhannn",
      label: "Instagram",
    },
  ];
